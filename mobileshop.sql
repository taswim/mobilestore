...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2022 at 10:07 AM
...
(1, 'pbkdf2_sha256$320000$k0Ywus5jqMRFRpYdpA0LwJ$JqCZdtLdYKf46Ko3foJt6K2PEKp0Q/rx2USbcWul7Ck=', '2022-06-06 08:00:15.805241', 1, 'rithesh', '', '', 'retashghosh@gmail.com', 1, 1, '2022-04-12 08:44:46.072285'),
(2, 'pbkdf2_sha256$320000$OSF1W7xJzugyEFaaIBuYcO$O72dRLvWCT71Oe74KnZia4qL/ALd8GIYFeDwZKbGwxw=', NULL, 1, 'Tasnim', 'Tasnim', 'Tabassum', 'tasnimtabassum346@gmail.com', 1, 1, '2022-06-06 08:02:47.000000'),
(3, 'pbkdf2_sha256$320000$fRvS495LfBt1vHv5D6xDF4$5zpDV/WBMsUdI/rp79LOnV1Cg8eSk8p4Q7NECTSBqK4=', NULL, 1, 'Adity23', '', '', '', 1, 1, '2022-06-06 08:05:12.000000');
...
(7, '2022-06-06 08:02:47.432859', '2', 'Tasnim', 1, '[{\"added\": {}}]', 4, 1),
(8, '2022-06-06 08:03:59.418255', '2', 'Tasnim', 2, '[{\"changed\": {\"fields\": [\"First name\", \"Last name\", \"Email address\", \"Staff status\", \"Superuser status\", \"User permissions\"]}}]', 4, 1),
(9, '2022-06-06 08:05:12.223475', '3', 'Adity23', 1, '[{\"added\": {}}]', 4, 1),
(10, '2022-06-06 08:05:21.985012', '3', 'Adity23', 2, '[{\"changed\": {\"fields\": [\"Staff status\", \"Superuser status\", \"User permissions\"]}}]', 4, 1);
...
('nueyl1dzg9vj7vctrukfcl7uxb30ffbs', '.eJxVjMsOwiAQRf-FtSHQDo-6dO83kJkBpGogKe3K-O_apAvd3nPOfYmA21rC1tMS5ijOQovT70bIj1R3EO9Yb01yq-syk9wVedAury2m5-Vw_w4K9vKtAcFgQkx2cAiZyVjj88igRkJ0zHmIoCw4Y7z1kyZP44RKc3ZReWfF-wP7wDgB:1ny7de:ti6ZR4cEHCgntnXzRt9QJbM8V-iRnEr6aj2I4DneGZ8', '2022-06-20 07:59:02.870077'),
...
--
-- Dumping data for table `shop_checkoutdetail`
--

INSERT INTO `shop_checkoutdetail` (`id`, `phone_number`, `total_amount`, `address`, `city`, `state`, `zipcode`, `payment`, `date_added`, `customer_id`, `order_id`) VALUES
(1, '123456789', '3996.0', 'Shankarpur', 'Dhaka', 'Dhaka', '1234', 'Cash On Delivery', '2022-06-05 04:18:15.022170', 1, 1),
(2, '123456789', '999.0', 'Shankarpur', 'Dhaka', 'Dhaka', '1234', 'Cash On Delivery', '2022-06-05 04:22:22.776915', 1, 2);
...
(1, '2022-04-12 08:44:53.984872', 1, 1),
(2, '2022-06-05 04:18:22.038725', 1, 1),
(3, '2022-06-05 04:22:30.400203', 0, 1);
...
(5, 4, '2022-04-12 21:55:20.270498', 1, 1),
(6, 1, '2022-06-05 04:21:57.910666', 2, 1);
...
(2, 2, 'Your Order is Successfully Placed.', '2022-06-05');
